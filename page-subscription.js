...
const FEATURES = [
  ...
  { icon: '👛',
    ...
    desc_ko: 'Pi 로그인만 하면 Pi 잔액·토큰·LP 예치 현황을 자동으로 조회합니다. 필요 시 다른 지갑 주소로 변경도 가능합니다.',
    desc_en: 'Automatically shows your Pi balance, tokens and LP positions on login. You can also view any other wallet address.',
    desc_id: 'Secara otomatis menampilkan saldo Pi, token, dan posisi LP saat login. Bisa juga melihat alamat dompet lain.',
    desc_zh: 'Pi登录后自动显示Pi余额、代币及LP质押状况。也可切换查看其他钱包地址。',
    desc_ja: 'Piログインするだけで自動的にPi残高・トークン・LP預入状況を表示します。別のウォレットアドレスへの変更も可能です。',
    desc_es: 'Muestra automáticamente el saldo Pi, tokens y posiciones LP al iniciar sesión. También puede ver otras carteras.',
    desc_vi: 'Tự động hiển thị số dư Pi, token và vị thế LP khi đăng nhập. Cũng có thể xem địa chỉ ví khác.',
    desc_hi: 'Pi लॉगिन करते ही Pi बैलेंस, टोकन, LP पोजीशन स्वतः दिखती है। अन्य वॉलेट पता भी देख सकते हैं।',
    desc_pt: 'Exibe automaticamente saldo Pi, tokens e posições LP ao fazer login. Também é possível ver outras carteiras.',
    desc_tl: 'Awtomatikong nagpapakita ng Pi balance, tokens at LP positions sa pag-login. Maaari ring tingnan ang ibang wallet address.',
    desc_fr: 'Affiche automatiquement votre solde Pi, les tokens et vos positions LP à la connexion. Vous pouvez aussi voir d\'autres portefeuilles.' },
  { icon: '↓',
